...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vcvgcl4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vcvgcl4.containers.anotherwebservice.com/
...
```
git clone git@github.com:TheLiquidIvy/container-vcvgcl4.git
cd container-vcvgcl4
```
...
```
docker attach container-vcvgcl4
```
